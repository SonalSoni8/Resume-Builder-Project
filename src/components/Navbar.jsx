    ...
    return (
        <nav className="h-[60px] bg-slate-100 shadow">
            <div className="justify-between px-4 mx-auto lg:max-w-7xl lg:items-center lg:grid lg:grid-cols-2 lg:px-6">
                ...
                <div
                    className={`flex mx-44 justify-self-center mt-2 md:block rounded-xl p-2 bg-white shadow-lg lg:shadow-none w-44 lg:w-full lg:bg-slate-100 ${navbar ? "block" : "hidden"
                        }`}
                >
