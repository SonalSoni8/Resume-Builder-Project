    ...
    <div className='bg-white m-6 rounded-2xl shadow p-2 relative '>
      ...
      <div className='lg:grid lg:grid-cols-2 pb-4 '>
        <div className=' lg:mx-40'>
          <div className='rounded-xl bg-white shadow-lg items-center flex justify-center max-[320px]:scale-x-[85%] max-[320px]:w-full max-[393px]:scale-x-[85%] max-[393px]:w-full' ref={captureRef}>
            {templateComponent}
          </div>
        </div>
