...
const Template2 = () => {
    ...
    return (
        <div className='w-full lg:max-w-sm p-2'>
            ...
            <div className='flex flex-col bg-white shadow rounded-lg h-auto border border-black' >
            ...
            />
                    ...
                    <div className='text-black text-center'>
                        {/* name */}
                        <h1 className='font-bold tracking-widest uppercase text-3xl pb-4'>{fname} {lname}</h1>
                    </div>
                    <hr className='border border-black mb-4' />
                    <div className='text-black text-sm justify-between flex flex-col items-center text-center'>
                        <h1 className='font-bold uppercase tracking-widest'>About Me</h1>
                        <p className=''>{obje}</p>
                    </div >
              ...
              <div className='text-black text-sm p-4 justify-between flex flex-col gap-2 items-center text-center'>
                <h1 className='font-bold uppercase tracking-widest'>Work Experience</h1>
...
<hr className='border border-black mx-5' />
              ...
              <p></p>
                    ...
                    <div>
                        {/* skills */}
                        {keySkills.length > 0 && (
                            <div className='text-black text-sm p-4 justify-between flex flex-col gap-2 items-center '>
                                <h1 className='font-bold uppercase tracking-widest'>Key Skills</h1>
                                <div>
                           ...
                           <hr className='border border-black mx-5' />
                        {/* contact */}
                        <div className='text-black text-sm p-4 justify-between flex flex-col  items-center gap-2 pb-8'>
                            <h1 className='font-bold tracking-widest uppercase '>Contact Me</h1>
...
{addr}</p>
                            <p className='flex flex-col items-center gap-2 text-center'>{city}, {state}</p>
                            <p className='flex flex-col items-center gap-2 text-center'>Postal Code: {pin}</p>
